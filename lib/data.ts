...
const RAW_WORKS: RawWork[] = [
  ...
  { title: "Osaka", year: 2026, dims: "Dimensions on request", h: "h-64", image: "/drawingosaka.jpg", medium: "Marker on paper", category: "Drawing", description: "A figure study in marker, part of a series of studio sketches made during the Osaka period." },
  { title: "Studio Floor (Sketches I)", year: 2026, dims: "Installation view", h: "h-72", image: "/drawingstudiofloor1.jpg", medium: "Marker on paper, studio installation view", category: "Drawing", description: "A studio floor view of an ongoing series of quick marker drawings — brand names, objects, and fragments of everyday observation laid out together." },
  { title: "Studio Floor (Sketches II)", year: 2026, dims: "Installation view", h: "h-96", image: "/drawingstudiofloor2.jpg", medium: "Marker on paper, studio installation view", category: "Drawing", description: "A studio floor view of an ongoing series of quick marker drawings — brand names, objects, and fragments of everyday observation laid out together." },
  { title: "Self-Portrait Head", year: 2026, dims: "Dimensions on request", h: "h-80", image: "/sculptureheadbust.jpg", medium: "Glazed ceramic", category: "Sculpture", description: "A hand-built ceramic self-portrait bust, signed and dated on the base." },
  { title: "Untitled (Seated Figure)", year: 2026, dims: "Dimensions on request", h: "h-64", image: "/sculptureseatedfigure.jpg", medium: "Glazed ceramic", category: "Sculpture", description: "A small seated figure, part of an ongoing series of hand-built ceramic figures." },
  { title: "Untitled (Figure with Raised Arms)", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/sculpturefigureraisedarms.jpg", medium: "Glazed ceramic", category: "Sculpture", description: "A standing figure with raised arms, part of an ongoing series of hand-built ceramic figures." },
  { title: "Pullin (Seat Study)", year: 2026, dims: "Dimensions on request", h: "h-72", image: "/sculpturepullinseatstudy.jpg", medium: "Found chair leg, bicycle seat, and plaster", category: "Sculpture", description: "A found-object sculpture from the \"Pullin\" series, repurposing a chair leg and bicycle seat as a plaster-coated form — part of an inquiry into candle, vase, and object forms." },
  { title: "Untitled (Standing Figure)", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/sculpturestandingfigure.jpg", medium: "Glazed ceramic, acrylic", category: "Sculpture", description: "A painted standing figure, part of an ongoing series of hand-built ceramic figures." },
  { title: "Untitled (Branch Form)", year: 2026, dims: "Dimensions on request", h: "h-64", image: "/sculpturebranchform.jpg", medium: "Glazed ceramic", category: "Sculpture", description: "A branching vessel form, part of an ongoing series of hand-built ceramic objects." },
  { title: "Untitled (Hand)", year: 2026, dims: "Dimensions on request", h: "h-72", image: "/sculpturehand.jpg", medium: "Ceramic", category: "Sculpture", description: "A hand-built ceramic study of a hand, left on the studio floor." },
  { title: "Pullin — Candle / Vase / Other", year: 2026, dims: "Installation view", h: "h-96", image: "/sculpturepullinposter.jpg", medium: "Found furniture, plaster, mixed media — series documentation", category: "Sculpture", description: "Documentation graphic for the \"Pullin\" series, in which found chair legs and furniture parts are recast as candles, vases, and other functional forms." },
  { title: "Drive-In", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingdrivein.jpg", medium: "Oil on canvas", category: "Painting", description: "A bearded figure in a Nike cap stands before an empty drive-in movie screen, the landscape behind flattened into bands of green and blue." },
  { title: "Matisse", year: 2026, dims: "Dimensions on request", h: "h-72", image: "/paintingmatisse.jpg", medium: "Oil on canvas", category: "Painting", description: "A close study of a face peering over the cover of a Matisse monograph, its \"Dance\" reproduced in miniature below." },
  { title: "Thailand Passport", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingpassport.jpg", medium: "Oil on canvas", category: "Painting", description: "A close-up rendering of a Thai passport cover, its golden Garuda emblem and lettering picked out against a maroon ground." },
  { title: "Selfie", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingselfie.jpg", medium: "Oil on canvas", category: "Painting", description: "A self-portrait in a knit beanie and sunglasses, phone raised to the mirror in the familiar gesture of the reflected photograph." },
  { title: "Made in Korea", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingmadeinkorea.jpg", medium: "Oil on canvas", category: "Painting", description: "A figure seated among stacked bales stamped \"Made in Korea\" and \"Toko Hong Yang,\" a dropped phone trailing its cable across the floor — a scene drawn from the global trade of secondhand and surplus goods." },
  { title: "Pablo Picasso", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingpicasso.jpg", medium: "Oil on canvas", category: "Painting", description: "A painted reproduction of the cover of \"Pablo Picasso: A Modern Master\" by Richard Leslie, rendering the reproduction of a cubist portrait within the painting itself." },
  { title: "CK", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingck.jpg", medium: "Oil on canvas", category: "Painting", description: "A seated portrait in a red tank top and branded waistband, framed by the orange wings of an armchair." },
  { title: "Enduro", year: 2026, dims: "Dimensions on request", h: "h-80", image: "/paintingenduro.jpg", medium: "Oil on canvas", category: "Painting", description: "A vintage enduro motorcycle parked on open ground beneath a seated figure, rendered in flat fields of rust and sky." },
  { title: "Paris Art Basel", year: 2026, dims: "Dimensions on request", h: "h-72", image: "/paintingartsy.jpg", medium: "Oil on canvas", category: "Painting", description: "A still life of an Artsy \"Paris Art Basel\" catalogue with a McDonald's bag set on top, pairing the language of the art fair with fast-food packaging." },
  { title: "Romanée-Conti", year: 2026, dims: "Dimensions on request", h: "h-72", image: "/paintingromaneeconti.jpg", medium: "Oil on canvas", category: "Painting", description: "A table still life with a bottle of Romanée-Conti set between two place settings, each plate holding a single dumpling." },
  { title: "Tennis Court", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingtenniscourt.jpg", medium: "Oil on canvas", category: "Painting", description: "A dog wanders a clay tennis court scattered with loose balls, seen from above in flattened red and pink." },
  { title: "The Last One", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintinglastone.jpg", medium: "Oil on canvas", category: "Painting", description: "A bearded figure reads a \"Ninja Hattori\" comic at a table set with a bottle of Kikkoman soy sauce, the words \"The Last One\" lettered below." },
  { title: "Untitled (Underwear)", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingunderwear.jpg", medium: "Oil on canvas", category: "Painting", description: "A standing figure in white underwear and blue socks against a brick and concrete ground, a small dark animal at the edge of the frame." },
  { title: "Fitting Room", year: 2026, dims: "Dimensions on request", h: "h-80", image: "/paintingfittingroom.jpg", medium: "Oil on canvas", category: "Painting", description: "Figures seen from behind browse a rack of branded T-shirts — Starbucks, Nike, and a striped pullover — hung above a row of sneakers." },
  { title: "Column", year: 2026, dims: "Dimensions on request", h: "h-96", image: "/paintingcolumn.jpg", medium: "Oil on canvas", category: "Painting", description: "Two figures carry a classical Ionic column fragment between them, a traffic-striped roundabout and tree behind." },
];
